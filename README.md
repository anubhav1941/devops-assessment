...
devprodAZs23NAT gateways1 shared1 per AZRDS instancedb.t4g.microdb.r6g.largeRDS multi-AZnoyesBackup retention1 day30 daysDeletion protectionoffonECS desired count13
To run:
cd infra/envs/dev
